...
mis_cve_ids = check_label(train_dataset, labeled_data, labels=['privilege-required','attack-vector','impact']) # 当前规则错误率 0.6995894160583942
print(json.dumps(mis_cve_ids,indent=4)) # log
# <check label accuracy end>

# compare dataset labeled by us and offical dataset
